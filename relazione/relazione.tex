...
Unica eccezione a questo fatto sono i risultati ottenuti per \verb|gr202| e \verb|gr229| che sono molto vicini a quelli ottenuti dall'algoritmo di 2-approssimazione. Abbiamo attribuito tale evento ad una pura casualità.\\
Essendo l'esecuzione di Held e Karp con un timeout troppo basso simile ad una visita in profondità dell'intero grafico, può accadere che tale cammino (chiuso a formare un ciclo unendo l'ultimo nodo aggiunto al nodo 0) rappresenti una soluzione approssimata abbastanza precisa.\\
\medskip
%TODO
Confrontando invece gli algoritmi approssimati
\begin{figure}[h]
	\centering
